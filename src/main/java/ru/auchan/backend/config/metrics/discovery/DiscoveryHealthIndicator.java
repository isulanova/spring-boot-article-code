...
public class DiscoveryHealthIndicator extends AbstractHealthIndicator implements DiscoveryClientHealthIndicator, Ordered, ApplicationListener<InstanceRegisteredEvent<?>> {
